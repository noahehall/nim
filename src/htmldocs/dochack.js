...
function HEX5BHEX5D_721421595(s_721421598, x_721421599) {
  var result_721421600 = [];
    ...
    Label1: {
      ...
      Label2: {
          Label3: while (true) {
          if (!(i_553649286 < L_721421604)) break Label3;
            i_721421609 = i_553649286;
...
async function loadIndex_553648978() {
  ...
  BeforeRet: {
    ...
    var rootURL_553649012 = HEX5BHEX5D_721421595(cstrToNimstr(indexURL_553648986), HEX2EHEX2E_956301412(0, 14));
